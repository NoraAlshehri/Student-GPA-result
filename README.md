...
* Designed the user interface using reusable Jetpack Compose components.
* Improved my understanding of state management, automatic UI recomposition, conditional rendering, and reusable composables through practical implementation.